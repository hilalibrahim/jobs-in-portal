...
const handleSubmit = async () => {
  ...
  try {
    const response = await axios.post('https://json-server-1-wn3q.onrender.com/jobs', newJob);
...
<option value="Over ₹20L">Over ₹20L</option>
          ...
          <div>
            <button
              class="bg-[#FF9666] hover:bg-[#f88c5a] text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Add Job
            </button>
